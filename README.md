...
- **`refactor`** — restructuring (code, markup, or config) with no change to *functional* behavior. Visual/positional changes are fine as long as what the thing does stays the same (e.g. moving a button without changing what it does).
